    ...
    <div className="min-h-screen bg-background">
      ...
      {/* <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-6">Cosmetic Import License</h1>
          
          <div className="space-y-6 text-muted-foreground">
            <p className="text-lg">
              Get your cosmetic import license quickly and hassle-free. We handle all documentation 
              and compliance requirements for importing cosmetic products into India.
            </p>
            ...
            <div className="bg-muted p-6 rounded-lg">
              ...
              <p>Typical processing time: 30-45 days</p>
            </div>
...
export default CosmeticImportLicense;
