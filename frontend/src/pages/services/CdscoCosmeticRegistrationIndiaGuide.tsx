...
import cdscoCosmeticHeroImage from "@/assets/images/guide1.jpeg";
import cdscoCosmeticProcessImage from "@/assets/images/process-cdsco-guide.jpeg";
import cdscoCosmeticIngredientImage from "@/assets/images/cosmetic-bis.jpeg";
import cdscoCosmeticDocumentsImage from "@/assets/images/documents-cosmetic-guide.png";
...
const CdscoCosmeticRegistrationIndiaGuide = () => {
  const navigate = useNavigate();
  const [openFaqIndex, setOpenFaqIndex] = useState<number | null>(null);
  const canonical = "https://regacats.in/cosmetic-registration-india-guide";
        ...
        <section className="py-14 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8">
              <Card className="border-cyan-100 shadow-sm flex flex-col">
                <CardHeader>
          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8">
            <Card className="border-cyan-100 shadow-sm flex flex-col">
              ...
              <CardContent className="flex-1 flex flex-col">
                ...
                <figure className="mt-auto rounded-xl border border-cyan-100 bg-white p-3">
                  <img
                    src={cdscoCosmeticDocumentsImage}
                    alt="Documents for CDSCO Cosmetic Registration in India"
                    title="Documents for CDSCO Cosmetic Registration in India"
                    className="w-full h-auto rounded-lg object-contain"
                    loading="lazy"
                  />
                  <figcaption className="mt-3 text-xs text-slate-600">
                    Essential documents required for cosmetic registration in India.
                  </figcaption>
                </figure>
              </CardContent>
            </Card>
...
export default CdscoCosmeticRegistrationIndiaGuide;
=======
import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { TopBar } from "@/components/TopBar";
