...
import cosmeticRegistrationImage from "@/assets/images/cosmetic-registration.jpeg";
import cosmeticProcessImage from "@/assets/images/cosmetic-process.jpeg";
...
const CdscoCosmeticRegistrationIndia = () => {
  ...
  const heroImageUrl = cosmeticRegistrationImage;
  const processImageUrl = cosmeticProcessImage;
      ...
      <main className="overflow-x-clip">
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="rounded-2xl border border-white/20 bg-white/10 p-2 backdrop-blur-sm shadow-2xl lg:ml-auto w-full max-w-2xl">
                <img
                  ...
                  title="CDSCO Cosmetic Registration Consultant India - For License"
                  className="w-full h-auto rounded-xl border border-white/20 object-cover"
                  loading="eager"
                />
              </div>
            </div>
            ...
            <Card className="border-cyan-100 shadow-sm">
              ...
              <CardContent>
                ...
                <ul className="space-y-2">
                  {serviceHighlights.slice(0, 2).map((item) => (
                  ...
                  <li className="flex items-start gap-2 text-slate-700">
                    <CheckCircle2 className="h-5 w-5 text-cyan-700 mt-0.5 shrink-0" />
                    <Link
                      to="/cosmetic-import-license-india"
                      className="text-cyan-800 underline underline-offset-2 hover:text-cyan-700"
                    >
                      Cosmetic Import License Consultation Service for importers
                    </Link>
                  </li>
                  {serviceHighlights.slice(2).map((item) => (
                    <li key={item} className="flex items-start gap-2 text-slate-700">
                      <CheckCircle2 className="h-5 w-5 text-cyan-700 mt-0.5 shrink-0" />
                      <span>{item}</span>
                    </li>
                ...
                <div className="rounded-2xl border border-cyan-100 bg-white p-3 md:p-4 shadow-sm mt-1">
                  <figure>
                    <img
                      ...
                      title="CDSCO Cosmetic Registration Process"
            ...
            <Card className="border-cyan-100 shadow-sm">
              ...
              <CardContent>
                ...
                <p className="text-slate-700 leading-relaxed mt-4">
                  ...
                  <Link to="/cosmetic-import-license-india" className="text-cyan-800 underline underline-offset-2 hover:text-cyan-700">
        ...
        <section className="py-16 bg-cyan-950 text-white">
          <div className="container mx-auto px-4 text-center max-w-3xl space-y-4">
            ...
            <p className="text-cyan-100">Looking for a reliable cosmetic product registration consultant?</p>
            <div className="space-y-2">
              <p className="text-cyan-100">Contact Regacats today for:</p>
              <ul className="space-y-2">
                <li className="flex items-start justify-center gap-2 text-cyan-100">
...
>>>>>>> a6ab51747866dd44ed763149d775b1c66ddd9773
