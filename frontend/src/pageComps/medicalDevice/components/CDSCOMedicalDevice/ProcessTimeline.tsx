...
export const ProcessTimeline = () => {
  const steps = [
    {
      icon: FileSearch,
      title: "Product Classification & Consultation",
      description: "Identify device class as per CDSCO rules"
    },
    {
      icon: FileText,
      title: "Documentation Preparation",
      description: "Compile technical files, FSC, and ISO certificates"
    },
    {
      icon: Send,
    ...
    },
    {
      ...
      description: "Delivery of your CDSCO Medical Device License"
    }
  ];
