...
const pages = [
  ...
  { loc: `${siteUrl}/non-specified-foodingredient-approval-india`, priority: "0.8", changefreq: "monthly" },
  ...
  { loc: `${siteUrl}/cdscoimport-service`, priority: "0.9", changefreq: "monthly" },
